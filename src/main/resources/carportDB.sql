...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carport`.`materiale` (
...
CREATE TABLE IF NOT EXISTS `carport`.`stykliste` (
  ...
  CONSTRAINT `fk_stykliste_ordre1`
    ...
    REFERENCES `carport`.`ordre` (`idordre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carport`.`m_variant` (
  ...
  CONSTRAINT `fk_m_variant_materiale1`
    ...
    REFERENCES `carport`.`materiale` (`idmateriale`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
